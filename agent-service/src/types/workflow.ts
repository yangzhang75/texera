...
export interface WorkflowContent {
  ...
  // The parameterized-canvas definition (which properties are exposed as form fields). The
  // agent never reads or edits it, but it lives in workflow.content and must survive an agent
  // save untouched -- rebuilding content without it would leave is_parameterized=true on a
  // workflow whose form has no fields. Carried through opaquely.
  readonly parameterization?: unknown;
}
