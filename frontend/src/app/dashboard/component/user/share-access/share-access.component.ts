...
import { USER_DATASET, USER_PROJECT, USER_TEMPLATED_WORKFLOW, USER_WORKFLOW } from "../../../../app-routing.constant";
    ...
    if (this.emailTags.length > 0) {
      this.emailTags.forEach(email => {
        ...
        if (this.type !== "computing-unit") {
          ...
          if (this.type === "template") routePath = USER_TEMPLATED_WORKFLOW;
